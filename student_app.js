...
parcelRequire = function(e, r, t, n) {
    ...
    "7Dq7": [function(require, module, exports) {
        ...
        module.exports = {
            ...
            child_is_female: function(e) {
                return "f" === (0,
                    n.get)(e.user.activeChild, "gender", "m")
            },
    ...
    "bHdm": [function(require, module, exports) {
        module.exports = {
            beforeSend: function(e) {
                ...
                e.setRequestHeader("X-Client-Version", "13"),
                    e.setRequestHeader("X-Client-Platform", "web"),
                    e.setRequestHeader("X-Child-Id", t || $('meta[name="x-child-id"]').attr("content")),
                    e.setRequestHeader("Authorization", $('meta[name="access-token"]').attr("content"))
            }
        };
    }
        , {}],
    "Ijak": [function(require, module, exports) {
        ...
        module.exports = {
            ...
            toggleSubjectHomeworkDetails: function(t, a) {
                var n, o = t.commit, d = a.childID, _ = a.item;
            ...
            openEvaluationsTab: function(e, t) {
                (0,
                    e.commit)("SET_CHILD_REPO_EVALUATIONS_TAB", {
                    childID: t.childID,
                    type: t.type
                })
            },
            ...
            loadTimeTable: function(e, a) {
                ...
                n("SET_CHILD_REPO_TIMETABLE_LOADING", {
                    ...
                    d = d || t().startOf("isoweek").format("YYYY-MM-DD"),
                    _ = _ || t().startOf("isoweek").add(4, "days").format("YYYY-MM-DD"),
                    $.ajax({
            ...
            loadIzpite: function(e) {
                return e.commit("SET_IZPITI_LOADING", !0),
                    new Promise(function(t) {
                            $.ajax({
                                ...
                                "ok" === a.status && (e.commit("SET_IZPITI_LOADING", !1),
                                    e.commit("SET_IZPITI_ODPRTE_PRIJAVE", a.data.odprte_prijave),
                                    e.commit("SET_IZPITI_PRIJAVLJENI_IZPITI", a.data.prijavljeni_izpiti),
                                    t())
                            })
                        }
                    )
        ...
        module.exports = {
            ...
            ADD_CHILD_REPO_NEWSFEED_PAGE: function(e, a) {
                var t = a.childID
                    ...
                    , d = a.items
                    , s = e.childData[t];
                s.newsfeed.pages[i].items = d,
                    s.newsfeed.pages[i].loaded = !0,
                    s.newsfeed.page = i + 1
            },
            ...
            SET_CHILD_REPO_HOMEWORK_DETAILS: function(e, a) {
                ...
                void 0 !== i && (t.details.items = i),
                void 0 !== s && (t.details.open = s)
            },
            ...
            SET_CHILD_REPO_MEALS_LOADING: function(e, a) {
                var t = a.childID
                    ...
                    , d = a.loaded
                    , s = e.childData[t];
                s.meals[i] && d ? (s.meals[i].loaded = d,
                    s.meals[i].items = []) : Vue.set(s.meals, i, {
                    items: [],
                    loaded: d
                })
            },
    ...
    "ByJG": [function(require, module, exports) {
        ...
        , {
            "vue-router": "1iTB",
            "_bundle_loader": "TVvX",
            "./app/containers/feed": [["feed.e6a46a2b.js", "quwm"], "quwm"],
            "./app/izpiti/IzpitiHome.vue": [["IzpitiHome.070951ec.js", "J10S"], "IzpitiHome.070951ec.css", "J10S"],
            "./app/izpiti/IzpitiEdit.vue": [["IzpitiEdit.72753847.js", "PsmK"], "IzpitiEdit.72753847.css", "PsmK"],
            "./app/containers/grades": [["grades.3fd19b19.js", "u5Y7"], "u5Y7"],
            "./app/containers/subject_grades": [["subject_grades.84f4d4d1.js", "G1m5"], "G1m5"],
            "./app/containers/absences": [["absences.ba48ae8a.js", "VIf4"], "VIf4"],
            "./app/containers/absences_basic": [["absences_basic.6958bcb1.js", "Fggs"], "Fggs"],
            "./app/containers/examinations": [["examinations.253258c4.js", "Vxj6"], "Vxj6"],
            "./app/containers/examinations_basic": [["examinations_basic.133df2ff.js", "LZHZ"], "LZHZ"],
            "./app/containers/calendar": [["calendar.f95e96e1.js", "IWpB"], "IWpB"],
            "./app/containers/videokonferenca": [["videokonferenca.30a2ea83.js", "Q1Ni"], "Q1Ni"],
            "./app/containers/homework": [["homework.73287e87.js", "x8os"], "x8os"],
            "./app/containers/subject_homework": [["subject_homework.0ab0129c.js", "O8a/"], "O8a/"],
            "./app/containers/x360": [["x360.138363e7.js", "xOB2"], "xOB2"],
            "./app/containers/food": [["food.3c45c9dd.js", "uGro"], "uGro"],
            "./app/containers/food_order": [["food_order.7f6a7b70.js", "WcxO"], "WcxO"],
            "./app/containers/consent": [["consent.7e7484a0.js", "4frC"], "4frC"],
            "./app/containers/consent_list": [["consent_list.6c509090.js", "+WDy"], "+WDy"],
            "./app/containers/consent_item": [["consent_item.e4e66434.js", "Y1OV"], "Y1OV"]
        }],
            ...
            methods: {
                getTrialVersionEndTime: function() {
                    ...
                    e.child.notifications.forEach(function(n) {
                        "request_plus" === n.type && (e.end_time = new Date(n.end_time).getTime(),
                            e.countdownTimer())
                    })
                },
                countdownTimer: function() {
                    var e = this
                        ...
                        e.now = (new Date).getTime(),
                            e.distance = e.end_time - e.now,
                        e.distance < 0 && (clearInterval(n),
        ...
        module.exports = {
            ...
            methods: {
                getContent: function(n) {
                    var t = !1
                        , o = this.url;
                    return o.indexOf("/") > -1 && (o = "/" + o.split("/")[1]),
                        "/x360" === o ? t = "text" === n ? "Vse <strong>pohvale</strong>, potrebne izboljšave in komentarje si lahko pogledaš v <strong>aplikaciji</strong>." : e + "phone-x360-ea.png" : "/absences" === o || "/absences_basic" === o ? t = "text" === n ? "Ali veš koliko izostankov imaš? <strong>Poglej si v aplikaciji</strong>." : e + "phone-izostanki-ea.png" : "/examinations" === o || "/examinations_basic" === o ? t = "text" === n ? "Aplikacija ti ponuja pregled nad <strong>prihodnjimi</strong> in preteklimi ocenjevanji znanja." : e + "phone-ocenjevanje-znanja-ea.png" : "/grades" === o ? t = "text" === n ? "Želiš <strong>enostaven</strong> pregled nad vsemi ocenami na enem mestu?" : e + "phone-ocene-ea.png" : "/homework" === o ? t = "text" === n ? "Ali veš, da so <strong>v aplikaciji</strong> podrobnosti vpisanih domačih nalog?" : e + "phone-naloge-ea.png" : "/food" === o ? t = "text" === n ? "V aplikaciji lahko <strong>enostavno</strong> in <strong>hitro</strong> urediš svojo prijavo na obrok." : e + "phone-prehrana-ea.gif" : "/calendar" === o && (t = "text" === n ? "Z <strong>mobilno aplikacijo</strong> ti je urnik vedno pri roki. <strong>Hitro</strong> lahko pogledaš vsa nadomeščanja in ostale dogodke." : e + "phone-urnik.png"),
                        t
                },
                getOS: function() {
    ...
    "IjgZ": [function(require, module, exports) {
        ...
        function a() {
            r.default.locale("sl"),
                ...
                Vue.component("app-header", require("./app/header")),
                Vue.component("app-menu", require("./app/menu")),
                Vue.component("app-banner", require("../global/vue-runtime-components/ads/banner")),
                (0,
                    o.init_vue_filters)(Vue),
                new Vue({
                    el: "#xa-app",
                    store: e.store,
                    router: t.router,
                    ...
                    mounted: function() {
                        ...
                        this.menu.loaded || (this.$store.dispatch("loadAppMenu"),
                ...
                potrdi: function() {
                    ...
                    this.loading || (this.loading = !0,
                        $.ajax({
                            ...
                            a.loading = !1,
                                e.default.error(i.AJAX_ERROR)
                        }).done(function(t) {
                            a.loading = !1,
                                (0,
                                    i.check_rsp)(t, !1) ? (e.default.success("Prijavnica oddana."),
                                    a.$router.push({
                                        name: "izpiti"
                                    }),
                    ...
                    return this.samo_brez_odziva && (o = o.filter(function(e) {
                        ...
                        o = o.map(function(o) {
                            var i = function() {
                                var i = o.status;
                                if ("pridem" === i)
                                    return e.$store.getters.child_is_female ? "Uspešno si oddala prijavnico na izpite. O terminih boš obveščena, ko bodo določeni." : "Uspešno si oddal prijavnico na izpite. O terminih boš obveščen, ko bodo določeni.";
                                if ("ne_pridem" === i)
                                    return "Tvoja izbira: NE ŽELIM SE PRIJAVITI";
                                var r = (0,
                                    t.format_date)(o.konec);
        ...
        var e = {
            ...
            computed: {
                ...
                uredi_route: function() {
                    var e = this.predmet.id_izpit;
                    if (void 0 !== this.prijavno_obdobje)
                        return {
                            name: "izpit_uredi",
                            params: {
                                id_izpit: e
